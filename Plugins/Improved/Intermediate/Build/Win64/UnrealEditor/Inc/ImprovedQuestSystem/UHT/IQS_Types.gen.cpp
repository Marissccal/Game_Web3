...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics
{
	static constexpr FEnumRegisterCompiledInInfo EnumInfo[] = {
		{ EQuestState_StaticEnum, TEXT("EQuestState"), &Z_Registration_Info_UEnum_EQuestState, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3760820868U) },
		{ EMarkersMainTypes_StaticEnum, TEXT("EMarkersMainTypes"), &Z_Registration_Info_UEnum_EMarkersMainTypes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 4073649530U) },
		{ EQuestLogTypes_StaticEnum, TEXT("EQuestLogTypes"), &Z_Registration_Info_UEnum_EQuestLogTypes, CONSTRUCT_RELOAD_VERSION_INFO(FEnumReloadVersionInfo, 3770230605U) },
	...
	static constexpr FStructRegisterCompiledInInfo ScriptStructInfo[] = {
		...
		{ FMinimapLevelSettings::StaticStruct, Z_Construct_UScriptStruct_FMinimapLevelSettings_Statics::NewStructOps, TEXT("MinimapLevelSettings"), &Z_Registration_Info_UScriptStruct_MinimapLevelSettings, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FMinimapLevelSettings), 3025347154U) },
		{ FQuestObjectiveTarget::StaticStruct, Z_Construct_UScriptStruct_FQuestObjectiveTarget_Statics::NewStructOps, TEXT("QuestObjectiveTarget"), &Z_Registration_Info_UScriptStruct_QuestObjectiveTarget, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestObjectiveTarget), 805057521U) },
		{ FDoorPointsByLevels::StaticStruct, Z_Construct_UScriptStruct_FDoorPointsByLevels_Statics::NewStructOps, TEXT("DoorPointsByLevels"), &Z_Registration_Info_UScriptStruct_DoorPointsByLevels, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FDoorPointsByLevels), 3722600534U) },
		{ FSequenceMaster::StaticStruct, Z_Construct_UScriptStruct_FSequenceMaster_Statics::NewStructOps, TEXT("SequenceMaster"), &Z_Registration_Info_UScriptStruct_SequenceMaster, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FSequenceMaster), 2494198134U) },
		{ FPlayerProgress::StaticStruct, Z_Construct_UScriptStruct_FPlayerProgress_Statics::NewStructOps, TEXT("PlayerProgress"), &Z_Registration_Info_UScriptStruct_PlayerProgress, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FPlayerProgress), 1727232475U) },
		{ FQuestType::StaticStruct, Z_Construct_UScriptStruct_FQuestType_Statics::NewStructOps, TEXT("QuestType"), &Z_Registration_Info_UScriptStruct_QuestType, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestType), 3744768283U) },
		{ FQuestLogInfo::StaticStruct, Z_Construct_UScriptStruct_FQuestLogInfo_Statics::NewStructOps, TEXT("QuestLogInfo"), &Z_Registration_Info_UScriptStruct_QuestLogInfo, CONSTRUCT_RELOAD_VERSION_INFO(FStructReloadVersionInfo, sizeof(FQuestLogInfo), 1693113496U) },
	};
...
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_3938892621(TEXT("/Script/ImprovedQuestSystem"),
	Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics::ClassInfo),
	Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics::ScriptStructInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics::ScriptStructInfo),
	Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics::EnumInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Unreal_Engine_5_Game_Web3_Plugins_Improved_Source_ImprovedQuestSystem_Public_Structure_IQS_Types_h_Statics::EnumInfo));
// End Registration
